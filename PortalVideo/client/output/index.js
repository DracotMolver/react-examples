...
var Agent = __webpack_require__(86);
...
exports.LogoutForm = exports.LoginForm = undefined;
...
var _messages = __webpack_require__(91);
...
var LoginForm = exports.LoginForm = function (_React$Component) {
    ...
    function LoginForm(props) {
        ...
        _this.handlerFocusInputs = _this.handlerFocusInputs.bind(_this);
        _this.handlerBlurInputs = _this.handlerBlurInputs.bind(_this);
    ...
    _createClass(LoginForm, [{
        ...
        value: function handleSubmitForm(e) {
            ...
            if (password.value.length > 2 && username.value.length > 2) {
                ...
                _superagent2.default.post('/user/auth').type('form') // Shorthand to use the content type as: application/x-www-form-urlencoded
                .send({
                    'username': username.value,
                    'password': (0, _jsMd2.default)(password.value) // Encrypt the password
                    ...
                    if (err) {
                        ...
                        if (res.body.status === 'success') {
                            ...
                            _this2.props.history.push('videos-list');
                        } else {
                            _this2.setState({
        ...
        key: 'handlerFocusInputs',
        value: function handlerFocusInputs(e) {
            var element = e.target;

            if (!element.id.includes('lbl')) {
                // Does not has lbl class
                var label = document.getElementById('lbl-' + e.target.id);
                label.classList.contains('login-form-label-anim') || (label.classList.add('login-form-label-anim'), element.classList.add('login-form-input-active'));
            } else {
                element.classList.contains('login-form-label-anim') || (element.classList.add('login-form-label-anim'), document.getElementById(element.id.replace('lbl-', '')).classList.add('login-form-input-active'));
            }
        }
    }, {
        key: 'handlerBlurInputs',
        value: function handlerBlurInputs(e) {
            // It works along with handlerFocus function
            var element = e.target;

            !!element.value.length || (element.classList.remove('login-form-input-active'), document.getElementById('lbl-' + element.id).classList.remove('login-form-label-anim'));
        }
        ...
        value: function render() {
            var _state = this.state,
                messageText = _state.messageText,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'grid-40 grid-parent login-form shadow' },
                    _react2.default.createElement(
                        'form',
                        { onSubmit: this.handleSubmitForm },
                        _react2.default.createElement(
                            'div',
                            { className: 'grid-100 grid-parent login-form-title' },
                            _react2.default.createElement(
                                'span',
                                null,
                                'Video portal'
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'button',
                                { className: 'button shadow', type: 'submit' },
                                'Login'
                            )
                        )
                    )
...
var LogoutForm = exports.LogoutForm = function LogoutForm() {
    var handleClickButtonForm = function handleClickButtonForm() {
        var userData = JSON.parse(sessionStorage.getItem('userData'));

        if (userData) {
            _superagent2.default.get('/user/logout').type('form').query({
    ...
    return _react2.default.createElement(
        'button',
        { type: 'button', onClick: handleClickButtonForm },
        'Log out'
    );
};
...
var Header = function Header() {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'grid-100 grid-parent header-nav' },
        _react2.default.createElement(
            'div',
            { className: 'grid-container' },
            _react2.default.createElement(
                ...
                _react2.default.createElement(_LoginForm.LogoutForm, null)
            )
        )
    );
};
...
exports.VideoCardBig = exports.VideoCardItem = undefined;
...
var _VideoDescription = __webpack_require__(95);

var _VideoDescription2 = _interopRequireDefault(_VideoDescription);

var _VideoRatePopPup = __webpack_require__(96);

var _VideoRatePopPup2 = _interopRequireDefault(_VideoRatePopPup);

var _VideoFullScreen = __webpack_require__(97);

var _VideoFullScreen2 = _interopRequireDefault(_VideoFullScreen);

var _VideoRating = __webpack_require__(98);

var _VideoRating2 = _interopRequireDefault(_VideoRating);

var _VideoLoader = __webpack_require__(33);

var _VideoLoader2 = _interopRequireDefault(_VideoLoader);

var _VideoThumb = __webpack_require__(99);
...
var VideoCardItem = exports.VideoCardItem = function (_React$Component) {
    _inherits(VideoCardItem, _React$Component);

    function VideoCardItem() {
        _classCallCheck(this, VideoCardItem);

        return _possibleConstructorReturn(this, (VideoCardItem.__proto__ || Object.getPrototypeOf(VideoCardItem)).apply(this, arguments));
    }

    _createClass(VideoCardItem, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'grid-100 video-container shadow zoomInUp-anim' },
                _react2.default.createElement(
                    'div',
                    { className: 'grid-100' },
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'grid-100' },
                    _react2.default.createElement(_VideoThumb2.default, { id: id, description: description })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'grid-100' },
                    _react2.default.createElement(_VideoDescription2.default, { description: description })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'grid-100' },
...
var VideoCardBigWrapper = function (_React$Component2) {
    _inherits(VideoCardBigWrapper, _React$Component2);

    function VideoCardBigWrapper(props) {
        _classCallCheck(this, VideoCardBigWrapper);

        var _this3 = _possibleConstructorReturn(this, (VideoCardBigWrapper.__proto__ || Object.getPrototypeOf(VideoCardBigWrapper)).call(this, props));

        _this3.state = {
            displayPopUp: false
        };

        _this3.handleClickRate = _this3.handleClickRate.bind(_this3);
        _this3.hidePopUp = _this3.hidePopUp.bind(_this3);
        return _this3;
    }
    ...
    _createClass(VideoCardBigWrapper, [{
        key: 'handleClickRate',
        value: function handleClickRate() {
            this.setState({
                displayPopUp: true
            });
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'video-single-container' },
                _react2.default.createElement(_VideoRatePopPup2.default, {
                    idToRate: _id,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { className: 'back-arrow', to: '/videos-list' },
                            '\u2190 Back to the list'
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'grid-100 grid-parent video-container shadow' },
                        _react2.default.createElement(
                            'div',
                            { className: 'grid-100 grid-parent' },
                            _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'grid-100' },
                            _react2.default.createElement(_VideoFullScreen2.default, { url: url })
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'grid-100' },
    ...
    return VideoCardBigWrapper;
}(_react2.default.Component);

var VideoCardBig = exports.VideoCardBig = (0, _VideoLoader2.default)('videoData')(VideoCardBigWrapper);
...
var videoLoader = function videoLoader(propname) {
    return function (WrapperComponent) {
        return function (_React$Component) {
            _inherits(VideoLoader, _React$Component);
            ...
            _createClass(VideoLoader, [{
                ...
                value: function render() {
                    ...
                    return (_typeof(this.props[propname]) === 'object' ? Object.keys(this.props[propname]).length : !!this.props[propname].length) ? _react2.default.createElement(WrapperComponent, this.props) : _react2.default.createElement('div', { className: 'spinner' });
                }
            }]);
...
var _PrivateRouter = __webpack_require__(92);

var _PrivateRouter2 = _interopRequireDefault(_PrivateRouter);

var _VideoListContainer = __webpack_require__(93);

var _VideoListContainer2 = _interopRequireDefault(_VideoListContainer);

var _VideoSingleContainer = __webpack_require__(100);

var _VideoSingleContainer2 = _interopRequireDefault(_VideoSingleContainer);
...
var App = function App() {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _LoginForm.LoginForm }),
            _react2.default.createElement(_PrivateRouter2.default, {
                exact: true,
                path: '/videos-list',
                component: _VideoListContainer2.default
            }),
            _react2.default.createElement(_PrivateRouter2.default, {
                path: '/videos-list/:id',
                component: _VideoSingleContainer2.default
            })
        )
    );
};
...
(function () {
  ...
  var AMD = "function" === 'function' && __webpack_require__(90);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(88), __webpack_require__(89)))
...
var Message = function Message(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: messageType !== '' ? msgCSSClass[messageType] : '' },
            messageText
        )
    );
};
...
var PrivateRouter = function PrivateRouter(_ref) {
    ...
    return isAuthenticated() ? _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
...
var _VideoList = __webpack_require__(94);
...
var VideoSingleContainer = function (_React$Component) {
    _inherits(VideoSingleContainer, _React$Component);

    function VideoSingleContainer(props) {
        _classCallCheck(this, VideoSingleContainer);

        var _this = _possibleConstructorReturn(this, (VideoSingleContainer.__proto__ || Object.getPrototypeOf(VideoSingleContainer)).call(this, props));
        ...
        };_this.getMoreVideos = _this.getMoreVideos.bind(_this);
        return _this;
    }

    // -============================ OWN EVENTS ============================-

    _createClass(VideoSingleContainer, [{
        key: 'getMoreVideos',
        value: function getMoreVideos() {
            var _this2 = this;

            var _state = this.state,
                lastValue = _state.lastValue,
                videoList = _state.videoList;
            ...
            _superagent2.default.get('/videos').query({
    ...
    return VideoSingleContainer;
}(_react2.default.Component);

exports.default = VideoSingleContainer;
...
var _VideoCard = __webpack_require__(32);
...
var VideoList = function VideoList(props) {
    ...
    */
// -========================== MODULES ==========================-
exports.default = (0, _VideoLoader2.default)('videoList')(VideoList);
...
var InitialMessage = function InitialMessage(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'grid-100 rate-stars-input' },
                inputs
            ),
            _react2.default.createElement(
                'div',
...
var VideoRatePopPup = function (_React$Component) {
    ...
    function VideoRatePopPup(props) {
        _classCallCheck(this, VideoRatePopPup);

        var _this = _possibleConstructorReturn(this, (VideoRatePopPup.__proto__ || Object.getPrototypeOf(VideoRatePopPup)).call(this, props));
        ...
        _this.handleChangeRate = _this.handleChangeRate.bind(_this);
    ...
    _createClass(VideoRatePopPup, [{
        key: 'handleChangeRate',
        value: function handleChangeRate(e) {
            this.setState({
        ...
        value: function handleClickDone() {
            ...
            var _props = this.props,
                hidePopUp = _props.hidePopUp,
                idToRate = _props.idToRate;


            _superagent2.default.post('/video/ratings').type('form').query({
        ...
        key: 'render',
        value: function render() {
            var displayPopUp = this.props.displayPopUp;


            return _react2.default.createElement(
                'div',
                { className: 'rate-stars-container ' + (displayPopUp ? '' : 'hide') },
                _react2.default.createElement(
                    'div',
                    { className: 'grid-container' },
                    _react2.default.createElement(
                        'div',
                        { className: 'rate-stars-popup shadow ' + (displayPopUp ? 'fadeInDown-anim' : '') },
                        this.state.isSuccess ? _react2.default.createElement(SuccessMessage, {
                            handleClickClose: this.handleClickClose
                        }) : _react2.default.createElement(InitialMessage, {
                            handleClickClose: this.handleClickClose,
...
var _Messages = __webpack_require__(101);
...
var VideoSingleContainer = function (_React$Component) {
    ...
    _createClass(VideoSingleContainer, [{
        ...
        value: function getVideoData() {
            ...
            _superagent2.default.get('/video').query({
                sessionId: userData.sessionId,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                null,
                _react2.default.createElement(_Header2.default, null),
                _react2.default.createElement(_VideoCard.VideoCardBig, { videoData: videoData }),
                _react2.default.createElement(_Messages2.default, { messageText: messageText, messageType: messageType })
            );
        }
    }]);
